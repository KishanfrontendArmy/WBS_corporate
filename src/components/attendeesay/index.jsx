                            ...
                            <div className="container">
                                <div className="what_attendees_say_inr d-flex align-items-center justify-content-between">
                                    ...
                                    <button onclick="pauseVid()" type="button">Pause Video</button> */}
                                        <a href="javascript:void(0)" data-click="0" onClick={() => playpause()} className="play-pause-btn d-flex align-items-center justify-content-center wow zoomIn">
                                            ...
                                            <svg className="btn_pause_icon" width="52" height="70" viewBox="0 0 52 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M6.6275 0C4.8704 0 3.1852 0.340274 1.9424 0.94593C0.6996 1.55159 0.0009 2.37312 0 3.22985V66.7685C0 67.6255 0.698199 68.4475 1.9411 69.0535C3.184 69.6596 4.8697 70 6.6275 70C8.3852 70 10.0709 69.6596 11.3138 69.0535C12.5567 68.4475 13.2549 67.6255 13.2549 66.7685V3.22985C13.254 2.37312 12.5553 1.55159 11.3125 0.94593C10.0697 0.340274 8.3845 0 6.6275 0Z" fill="black" />
                                                <path d="M44.8823 0C43.1252 0 41.44 0.340274 40.1973 0.94593C38.9545 1.55159 38.2558 2.37312 38.2549 3.22985V66.7685C38.2549 67.6255 38.9531 68.4475 40.196 69.0535C41.4389 69.6596 43.1246 70 44.8823 70C46.64 70 48.3258 69.6596 49.5686 69.0535C50.8115 68.4475 51.5098 67.6255 51.5098 66.7685V3.22985C51.5089 2.37312 50.8102 1.55159 49.5674 0.94593C48.3246 0.340274 46.6394 0 44.8823 0Z" fill="black" />
                                            </svg>                                        </a>
                                    </div>
                                </div>
                            </div>
